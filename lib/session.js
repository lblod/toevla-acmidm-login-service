...
const serviceHomepage = 'https://github.com/lblod/toevla-acmidm-login-service';
const resourceBaseUri = process.env.MU_APPLICATION_RESOURCE_BASE_URI || 'http://data.lblod.info/';
const personResourceBaseUri = `${resourceBaseUri}id/users/`;
const accountResourceBaseUri = `${resourceBaseUri}id/accounts/`;
const identifierResourceBaseUri = `${resourceBaseUri}id/identifiers/`;

const userIdClaim = process.env.MU_APPLICATION_AUTH_USERID_CLAIM || 'sub';
const accountIdClaim = process.env.MU_APPLICATION_AUTH_ACCOUNTID_CLAIM || 'sub';
